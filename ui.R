...
fluidPage(           
  div(
    ...
    # If not using custom CSS, set height  to a number instead of percent
    ...
    absolutePanel(
      ...
      conditionalPanel(
        ...
        sliderInput(
          inputId = "yearRange", label = "Select the Year Range",
          sep = "", step = 1, min = 2010, max = 2015, value = c(2010,2015)
          )
      ),
